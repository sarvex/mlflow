...
class MlflowClient(object):
    ...
    def create_model_version(
        ...
        if is_databricks_uri(self._registry_uri) and tracking_uri != self._registry_uri:
            ...
            eprint(
                f"=== Source model files were copied to {new_source} in the model registry workspace. You may want to delete the files once the model version is in 'READY' status. You can also find this location in the `source` field of the created model version. ==="
            )
